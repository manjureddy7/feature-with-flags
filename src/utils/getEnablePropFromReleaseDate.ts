 ...
 * @returns 
 */
const getFeatureFlagEnablePropForReleaseDate = (featureParams: ReleaseActivationStrategyFeatureParams): FeatureFlagReturnType => {
    ...
    if(featureFlagDetails[key]) {
        flagReleaseDate = featureFlagDetails?.releaseDate!;
    };
...
export default getFeatureFlagEnablePropForReleaseDate;